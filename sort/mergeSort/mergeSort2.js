...
//Split the split logic from sort logic



 var mergeSort = function(array) {
    //split into their own arrays
    ...
    var result = []
    var subRes = split //holds all arrays

    for (currSize; currSize < array.length-1; currSize *= 2) {
      for (leftStart = 0; leftStart < array.length-1; leftStart += 2*currSize) {
...
var mergeSortRecurse = function(array) {
